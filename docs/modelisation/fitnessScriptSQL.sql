...
-- sam. 27 avril 2019 20:55:32 CEST
...
CREATE TABLE IF NOT EXISTS `db_fitness`.`ProductCategory` (
  ...
  `nameProductCategory` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `db_fitness`.`Product` (
  ...
  `descriptionProduct` VARCHAR(255) NULL,
  `imageProduct` VARCHAR(45) NULL,
...
CREATE INDEX `fk_Product_ProductCategory1_idx` ON `db_fitness`.`Product` (`ProductCategory_idProductCategory` ASC);
