...
insert into product_ref (product_category_id_product_category, name_product_ref, price_product_ref, image_product_ref, description_product_ref) values (2, "Ovomaltine", 5, "Ovotamine_ovotamine.jpg", "");
insert into product_ref (product_category_id_product_category, name_product_ref, price_product_ref, image_product_ref, description_product_ref) values (1, "Montre Xiaomi", 100, "Watch 1_watchXioami.jpg", "Ceci est une montre formidable ! Accessible pour seulement 110 euros, à ce prix la, croyez-nous, c'est donné ! Ce magnifique appareil s'il en est, vous permettra comme n'importe quelle montre de pouvoir connaître en permanence l'heure qu'il est ! ");

insert into evenement (title_evt, description_evt, start_date_time_evt, end_date_time_evt, image_evt, video_evt) values ("Evt 1", "Description de l'événement 1", "2019-05-10 08:15", "2019-07-03 17:30", "", "");
insert into evenement (title_evt, description_evt, start_date_time_evt, end_date_time_evt, image_evt, video_evt) values ("Evt 2", "Description de l'événement 2", "2019-02-10 08:15", "2019-03-03 17:30", "", "");
insert into evenement (title_evt, description_evt, start_date_time_evt, end_date_time_evt, image_evt, video_evt) values ("Evt 3", "Description de l'événement 3", "2019-09-10 08:15", "2019-12-03 17:30", "", "");
insert into evenement (title_evt, description_evt, start_date_time_evt, end_date_time_evt, image_evt, video_evt) values ("Vidéo session", "Une vidéo pour faire des execices de fitness chez soi", "2019-01-22 08:15", "2019-11-03 17:30", "4_montecristo.jpeg", "https://www.youtube.com/watch?v=O8ElQBIenN0");
