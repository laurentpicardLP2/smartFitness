...
insert into command (id_command, date_of_command, status_command, total_price, customer_users_username) values (1, current_timestamp(), 3, 5, "db_abonne");
insert into item (id_item, price, type_item, quantity_item) values (1, 5, "Abonnement 1 jour:subscription", 1);
...
insert into command (id_command, date_of_command, status_command, total_price, customer_users_username) values (2, current_timestamp(), 3, 15, "db_abonne");
insert into item (id_item, price, type_item, quantity_item) values (2, 15, "Abonnement 3 jours:subscription", 1);
...
insert into command (id_command, date_of_command, status_command, total_price, customer_users_username) values (3, current_timestamp(), 3, 800, "db_abonne");
insert into item (id_item, price, type_item, quantity_item) values (3, 800, "Abonnement 1 an:subscription", 1);
...
insert into command (id_command, date_of_command, status_command, total_price, customer_users_username) values (4, current_timestamp(), 3, 600, "db_abonne");
insert into item (id_item, price, type_item, quantity_item) values (4, 500, "Abonnement 6 mois:subscription", 1);
