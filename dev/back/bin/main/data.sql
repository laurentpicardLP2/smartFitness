...
insert into users (username, enabled, password, fullname, id_user) values ("db_user", 1, "{bcrypt}$2a$10$JXRZi7XpNNJtjkv6Xvii0eQUvg85eEe69q.Esz3RMtd.wlKKlYNjS", "user", 3);
insert into customer (username) values ("db_user");
insert into authorities (username, authority) values ("db_user1", "ROLE_CUSTOMER");
insert into users (username, enabled, password, fullname, id_user) values ("db_user1", 1, "{bcrypt}$2a$10$ftMkD60z0PiSy3/Lzk4RQOO/EPjzxNuA6SxB3mBckdG95fDDkEZZa", "user1", 4);
insert into customer (username) values ("db_user1");
insert into authorities (username, authority) values ("db_user2", "ROLE_CUSTOMER");
insert into users (username, enabled, password, fullname, id_user) values ("db_user2", 1, "{bcrypt}$2a$10$Gywr3I/HPtAfSdhUTeDvkuqvnfDOLFktmah/uuXWF2htH6kLaiB0.", "user2", 5);
insert into customer (username) values ("db_user2");
insert into authorities (username, authority) values ("db_user3", "ROLE_CUSTOMER");
insert into users (username, enabled, password, fullname, id_user) values ("db_user3", 1, "{bcrypt}$2a$10$j00CcY/hTWOAOFsRr5z7G.fRujM1udGMlbJG4cdoOzGU6BT2LyxTi", "user3", 6);
insert into customer (username) values ("db_user3");
insert into authorities (username, authority) values ("db_user4", "ROLE_CUSTOMER");
insert into users (username, enabled, password, fullname, id_user) values ("db_user4", 1, "{bcrypt}$2a$10$wY.aG/K0O6MkJopPIR4WhuLyw4zrjdD2osXhLHVRmYr.QHmN8sxT.", "user4", 7);
insert into customer (username) values ("db_user4");
insert into authorities (username, authority) values ("db_user5", "ROLE_CUSTOMER");
insert into users (username, enabled, password, fullname, id_user) values ("db_user5", 1, "{bcrypt}$2a$10$ogO2h.sNSlKS1..MUpnSeOaHwO4PNTtmFJ8BwINxWNRA88Z5l1m8u", "user5", 8);
insert into customer (username) values ("db_user5");
insert into authorities (username, authority) values ("db_user6", "ROLE_CUSTOMER");
insert into users (username, enabled, password, fullname, id_user) values ("db_user6", 1, "{bcrypt}$2a$10$vJMerK8BAwOHNSwInrCHBO0r4usIzb8e3x3dNg4TZSo3KCZ4lpsLO", "user6", 9);
...
insert into users (username, enabled, password, fullname, id_user) values ("db_sebastien", 1, "{bcrypt}$2a$10$DzYEN3DGWBFihiHy5AqKuOSGODbp6Fl8DO1Q4DqF3cJdT/wb1PkI.", "sebastien", 10);
...
insert into users (username, enabled, password, fullname, id_user) values ("db_abonne", 1, "{bcrypt}$2a$10$eVEHILc2AIX3pkEr.2JNgus1viVpbLQX.L0tOPfiyJh3juirkv4Pe", "sysabonne", 11);
