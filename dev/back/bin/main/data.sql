...
insert into users (username, enabled, email, password, fullname, id_user) values ("db_sebastien", 1, "lolo.picard@laposte.net" ,"{bcrypt}$2a$10$DzYEN3DGWBFihiHy5AqKuOSGODbp6Fl8DO1Q4DqF3cJdT/wb1PkI.", "sebastien", 10);
